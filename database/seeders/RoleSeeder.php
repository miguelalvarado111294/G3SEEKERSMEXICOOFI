...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //cta espejo
        Permission::create(['name' => 'ctaespejo.index'])->syncRoles([$role1, $role2, $role3, $role4, $role5]); //Cobranza  
        Permission::create(['name' => 'ctaespejo.create'])->syncRoles([$role1, $role2]); //Cobranza  
        Permission::create(['name' => 'ctaespejo.edit'])->syncRoles([$role1, $role2]);  //Cobranza  
        Permission::create(['name' => 'ctaespejo.destroy'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'inventario'])->syncRoles([$role1, $role4]);
        Permission::create(['name' => 'renovaciones'])->syncRoles([$role1, $role2]);

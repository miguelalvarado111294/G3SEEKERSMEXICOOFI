...
<div class="card">
    <div class="card-body">
        <p><b>Cliente :</b> {{$cliente->segnombre}}  {{$cliente->nombre}}  {{$cliente->segnombre}}  {{$cliente->apellidopat}}  {{$cliente->apellidomat}}</p>
        <p><b>Datos del vehiculo: </b> {{$vehiculo->marca}} Modelo : {{$vehiculo->modelo}}  Placas : {{$vehiculo->placa}} color : {{$vehiculo->color}}</p>
